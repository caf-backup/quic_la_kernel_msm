...
#define AP147IOE_GPIO_LED_WAN	4
#define AP147IOE_GPIO_LED_LAN1	16
#define AP147IOE_GPIO_LED_LAN2	15
#define AP147IOE_GPIO_LED_LAN3	14
#define AP147IOE_GPIO_LED_LAN4	11
#define AP147IOE_GPIO_LED_STATUS	13
#define AP147IOE_GPIO_LED_WLAN_2G	12

#define AP147IOE_GPIO_BTN_WPS	17
...
static struct gpio_led ap147ioe_leds_gpio[] __initdata = {
	{
		.name		= "ap147ioe:green:status",
		.gpio		= AP147IOE_GPIO_LED_STATUS,
		.active_low	= 1,
	}, {
		.name		= "ap147ioe:green:wlan-2g",
		.gpio		= AP147IOE_GPIO_LED_WLAN_2G,
		.active_low	= 1,
	}, {
		.name		= "ap147ioe:green:lan1",
		.gpio		= AP147IOE_GPIO_LED_LAN1,
		.active_low	= 1,
	}, {
		.name		= "ap147ioe:green:lan2",
		.gpio		= AP147IOE_GPIO_LED_LAN2,
		.active_low	= 1,
	/*
	}, {
		.name		= "ap147ioe:green:lan3",
		.gpio		= AP147IOE_GPIO_LED_LAN3,
		.active_low	= 1,
		*/
	}, {
		.name		= "ap147ioe:green:lan4",
		.gpio		= AP147IOE_GPIO_LED_LAN4,
		.active_low	= 1,
	}, {
		.name		= "ap147ioe:green:wan",
		.gpio		= AP147IOE_GPIO_LED_WAN,
		.active_low	= 1,
	},
};
...
static void __init ap147ioe_common_setup(void)
{
	u8 *art = (u8 *)KSEG1ADDR(0x1fff0000);
