...
static struct resource resources_uart_gsbi1[] = {
	{
		.start	= IPQ806X_GSBI1_UARTDM_IRQ,
		.end	= IPQ806X_GSBI1_UARTDM_IRQ,
		.flags	= IORESOURCE_IRQ,
	},
	{
...
struct platform_device ipq806x_device_uart_gsbi1 = {
	.name	= "msm_serial_hsl",
	.id	= 1,
...
struct msm_rpm_platform_data ipq806x_rpm_data __initdata = {
	...
	.ipc_rpm_val = 4,
	.target_id =  {
		MSM_RPM_MAP(IPQ806X, NOTIFICATION_CONFIGURED_0, NOTIFICATION, 4),
		MSM_RPM_MAP(IPQ806X, NOTIFICATION_REGISTERED_0, NOTIFICATION, 4),
		MSM_RPM_MAP(IPQ806X, INVALIDATE_0, INVALIDATE, 8),
		MSM_RPM_MAP(IPQ806X, TRIGGER_TIMED_TO, TRIGGER_TIMED, 1),
		MSM_RPM_MAP(IPQ806X, TRIGGER_TIMED_SCLK_COUNT, TRIGGER_TIMED, 1),
		MSM_RPM_MAP(IPQ806X, RPM_CTL, RPM_CTL, 1),
		MSM_RPM_MAP(IPQ806X, CXO_CLK, CXO_CLK, 1),
		MSM_RPM_MAP(IPQ806X, PXO_CLK, PXO_CLK, 1),
		MSM_RPM_MAP(IPQ806X, APPS_FABRIC_CLK, APPS_FABRIC_CLK, 1),
		MSM_RPM_MAP(IPQ806X, SYSTEM_FABRIC_CLK, SYSTEM_FABRIC_CLK, 1),
		MSM_RPM_MAP(IPQ806X, MM_FABRIC_CLK, MM_FABRIC_CLK, 1),
		MSM_RPM_MAP(IPQ806X, DAYTONA_FABRIC_CLK, DAYTONA_FABRIC_CLK, 1),
		MSM_RPM_MAP(IPQ806X, SFPB_CLK, SFPB_CLK, 1),
		MSM_RPM_MAP(IPQ806X, CFPB_CLK, CFPB_CLK, 1),
		MSM_RPM_MAP(IPQ806X, MMFPB_CLK, MMFPB_CLK, 1),
		MSM_RPM_MAP(IPQ806X, EBI1_CLK, EBI1_CLK, 1),
		...
		MSM_RPM_MAP(IPQ806X, APPS_FABRIC_ARB_0, APPS_FABRIC_ARB, 12),
		...
		MSM_RPM_MAP(IPQ806X, SYSTEM_FABRIC_ARB_0, SYSTEM_FABRIC_ARB, 30),
		...
		MSM_RPM_MAP(IPQ806X, MM_FABRIC_ARB_0, MM_FABRIC_ARB, 21),
		MSM_RPM_MAP(IPQ806X, PM8921_S1_0, PM8921_S1, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_S2_0, PM8921_S2, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_S3_0, PM8921_S3, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_S4_0, PM8921_S4, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_S5_0, PM8921_S5, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_S6_0, PM8921_S6, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_S7_0, PM8921_S7, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_S8_0, PM8921_S8, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_L1_0, PM8921_L1, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_L2_0, PM8921_L2, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_L3_0, PM8921_L3, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_L4_0, PM8921_L4, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_L5_0, PM8921_L5, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_L6_0, PM8921_L6, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_L7_0, PM8921_L7, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_L8_0, PM8921_L8, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_L9_0, PM8921_L9, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_L10_0, PM8921_L10, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_L11_0, PM8921_L11, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_L12_0, PM8921_L12, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_L13_0, PM8921_L13, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_L14_0, PM8921_L14, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_L15_0, PM8921_L15, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_L16_0, PM8921_L16, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_L17_0, PM8921_L17, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_L18_0, PM8921_L18, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_L19_0, PM8921_L19, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_L20_0, PM8921_L20, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_L21_0, PM8921_L21, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_L22_0, PM8921_L22, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_L23_0, PM8921_L23, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_L24_0, PM8921_L24, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_L25_0, PM8921_L25, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_L26_0, PM8921_L26, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_L27_0, PM8921_L27, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_L28_0, PM8921_L28, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_L29_0, PM8921_L29, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_CLK1_0, PM8921_CLK1, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_CLK2_0, PM8921_CLK2, 2),
		MSM_RPM_MAP(IPQ806X, PM8921_LVS1, PM8921_LVS1, 1),
		MSM_RPM_MAP(IPQ806X, PM8921_LVS2, PM8921_LVS2, 1),
		MSM_RPM_MAP(IPQ806X, PM8921_LVS3, PM8921_LVS3, 1),
		MSM_RPM_MAP(IPQ806X, PM8921_LVS4, PM8921_LVS4, 1),
		MSM_RPM_MAP(IPQ806X, PM8921_LVS5, PM8921_LVS5, 1),
		MSM_RPM_MAP(IPQ806X, PM8921_LVS6, PM8921_LVS6, 1),
		MSM_RPM_MAP(IPQ806X, PM8921_LVS7, PM8921_LVS7, 1),
		MSM_RPM_MAP(IPQ806X, PM8821_S1_0, PM8821_S1, 2),
		MSM_RPM_MAP(IPQ806X, PM8821_S2_0, PM8821_S2, 2),
		MSM_RPM_MAP(IPQ806X, PM8821_L1_0, PM8821_L1, 2),
		MSM_RPM_MAP(IPQ806X, NCP_0, NCP, 2),
		MSM_RPM_MAP(IPQ806X, CXO_BUFFERS, CXO_BUFFERS, 1),
		MSM_RPM_MAP(IPQ806X, USB_OTG_SWITCH, USB_OTG_SWITCH, 1),
		MSM_RPM_MAP(IPQ806X, HDMI_SWITCH, HDMI_SWITCH, 1),
		MSM_RPM_MAP(IPQ806X, DDR_DMM_0, DDR_DMM, 2),
		MSM_RPM_MAP(IPQ806X, QDSS_CLK, QDSS_CLK, 1),
		MSM_RPM_MAP(IPQ806X, VDDMIN_GPIO, VDDMIN_GPIO, 1),
	},
	.target_status = {
		...
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_S1_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_S1_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_S2_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_S2_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_S3_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_S3_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_S4_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_S4_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_S5_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_S5_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_S6_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_S6_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_S7_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_S7_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_S8_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_S8_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L1_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L1_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L2_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L2_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L3_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L3_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L4_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L4_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L5_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L5_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L6_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L6_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L7_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L7_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L8_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L8_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L9_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L9_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L10_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L10_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L11_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L11_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L12_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L12_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L13_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L13_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L14_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L14_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L15_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L15_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L16_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L16_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L17_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L17_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L18_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L18_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L19_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L19_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L20_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L20_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L21_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L21_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L22_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L22_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L23_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L23_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L24_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L24_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L25_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L25_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L26_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L26_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L27_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L27_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L28_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L28_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L29_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_L29_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_CLK1_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_CLK1_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_CLK2_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_CLK2_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_LVS1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_LVS2),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_LVS3),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_LVS4),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_LVS5),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_LVS6),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8921_LVS7),
		...
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8821_S1_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8821_S1_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8821_S2_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8821_S2_1),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8821_L1_0),
		MSM_RPM_STATUS_ID_MAP(IPQ806X, PM8821_L1_1),
