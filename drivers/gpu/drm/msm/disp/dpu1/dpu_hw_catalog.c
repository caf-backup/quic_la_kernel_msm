...
static struct dpu_ctl_cfg sc7180_ctl[] = {
	...
	.name = "ctl_0", .id = CTL_0,
	.base = 0x1000, .len = 0xE4,
	.features = BIT(DPU_CTL_ACTIVE_CFG) | BIT(DPU_CTL_UIDLE)
	},
	{
	.name = "ctl_1", .id = CTL_1,
	.base = 0x1200, .len = 0xE4,
...
#define SC7180_LM_BLK(_name, _id, _base, _pp, _lmpair) \
	{ \
	.name = _name, .id = _id, \
	.base = _base, .len = 0x320, \
	.features = MIXER_SDM845_MASK, \
...
static struct dpu_lm_cfg sc7180_lm[] = {
	SC7180_LM_BLK("lm_0", LM_0, 0x44000, PINGPONG_0, LM_1),
	SC7180_LM_BLK("lm_1", LM_1, 0x45000, PINGPONG_1, LM_0),
};
...
static struct dpu_qos_lut_entry sc7180_qos_macrotile_qseed[] = {
	{.fl = 0, .lut = 0x0011223366777777},
};
...
static struct dpu_perf_cfg sc7180_perf_data = {
	...
	.min_llcc_ib = 800000,
	.min_dram_ib = 800000,
	.danger_lut_tbl = {0xff, 0xffff, 0x0, 0xffff},
	.qos_lut_tbl = {
		...
		{.nentry = ARRAY_SIZE(sc7180_qos_macrotile_qseed),
		.entries = sc7180_qos_macrotile_qseed
		},
	},
	.cdp_cfg = {
		{.rd_enable = 1, .wr_enable = 1},
