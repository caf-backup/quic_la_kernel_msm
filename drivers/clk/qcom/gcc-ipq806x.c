...
static const u8 gcc_pxo_pll0_pll8_pll11_pll3_map[] = {
	[P_PXO]		= 0,
	[P_PLL0]	= 2,
	[P_PLL8]	= 3,
	[P_PLL11]	= 5,
...
static const char *gcc_pxo_pll0_pll8_pll11_pll3[] = {
	"pxo",
	"pll0",
	"pll8",
	"pll11",
...
static const u8 gcc_pxo_mxo_pll0_pll8_map[] = {
	[P_PXO]		= 0,
	[P_MXO]		= 1,
	[P_PLL0]	= 2,
	[P_PLL8]	= 2,
...
static const char *gcc_pxo_mxo_pll0_pll8[] = {
	"pxo",
	"mxo",
	"pll0",
	"pll8",
...
static struct clk_rcg sata_ref_src = {
	...
	.s = {
		.src_sel_shift = 0,
		.parent_map = gcc_pxo_pll0_pll8_pll11_pll3_map,
	},
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			.name = "sata_ref_src",
			.parent_names = gcc_pxo_pll0_pll8_pll11_pll3,
			.num_parents = 5,
			.ops = &clk_rcg_ops,
			.flags = CLK_SET_RATE_GATE,
		},
...
static struct clk_branch sata_rxoob_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			.name = "sata_rxoob_clk",
			.parent_names = (const char *[]){ "sata_src_clk" },
			.num_parents = 1,
			.ops = &clk_branch_ops,
			.flags = CLK_SET_RATE_PARENT,
		},
...
static struct clk_rcg usb30_master_clk_src = {
	...
	.s = {
		.src_sel_shift = 0,
		.parent_map = gcc_pxo_mxo_pll0_pll8_map,
	},
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_names = gcc_pxo_mxo_pll0_pll8,
			.num_parents = 4,
			.ops = &clk_rcg_ops,
			.flags = CLK_SET_RATE_GATE,
		},
...
static struct clk_regmap *gcc_ipq806x_clks[] = {
	...
	[SFAB_SFPB_M_H_CLK] = &sfab_sata_s_h_clk.clkr,
