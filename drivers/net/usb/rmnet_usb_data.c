...
/* TODO: Add auto suspend call based on need here */ 
...
static const struct usb_device_id vidpids[] = {
	...
	{ USB_DEVICE_INTERFACE_NUMBER(0x05c6, 0x90E5, 6),
	.driver_info = (unsigned long)&rmnet_info,
	},
	{ USB_DEVICE_INTERFACE_NUMBER(0x05c6, 0x90F1, 2),
	.driver_info = (unsigned long)&rmnet_info,
	},
...
static int __init rmnet_data_init(void)
{
	int	retval;
